...
// Loads the SlotMap augmentations for settings.models.provider-card / .footer.
import type {} from '@deepseek-ai/dsh-client-ui-settings-models/client'
// Loads the SlotMap augmentation for settings.section.
...
export const CLIENT_NAMESPACE = 'llm-pi-ai'
