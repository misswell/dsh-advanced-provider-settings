 ...
 */
export declare const PluginSettingsSchema: z<PluginSettings>;
...
export interface SettingsServiceLike {
    register: (namespace: string, schema: unknown, options?: {
        validate?: (value: PluginSettings) => void;
 ...
 */
export declare function registerOwnSettings(settings: SettingsServiceLike): OwnSettingsHandle;
